...
$template1 = '<l><ifdef code="ca_objects.preferred_labels.name">^ca_objects.preferred_labels.name</ifdef><ifnotdef code="ca_objects.preferred_labels.name">[sans titre]</ifnotdef></l>';
