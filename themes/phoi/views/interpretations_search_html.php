            ...
            <div class="field-body">
                <div class="field">
                    ...
                    <select id="changeSearch">
                            ...
                            <option selected="selected"><?php _p('Interprétations'); ?></option>
...
<div class="container" style="margin-bottom: 100px;">
    ...
    <div style="text-align: center;font-weight: 700"><span id="nbresults"></span> <?php _p('résultats interprétations'); ?></div>
