...
<form method="get" action="<?php echo __CA_URL_ROOT__; ?>/index.php/Search/objects" id="search">
    <div style="margin: 54px 0 40px 0;">
            ...
            <div class="field-body">
                <div class="field">
                    ...
                    <select id="changeSearch">
                            ...
                            <option selected="selected"><?php _p('Livres'); ?></option>
                        </select>
                    </div>
                </div>
                <div class="field-label is-normal">
            ...
            <div class="field-body"> 
                <div class="field">
                    <div class="select" style="width:100%" />
                        <input class="input" id="form-auteur" style="width:100%" />
                    </div>
                </div>
            </div>
        ...
        <div class="field is-horizontal">
            <div class="field-label is-normal">
                <label class="label"><?php _p('Editeur'); ?></label>
            </div>
            <div class="field-body">
                <div class="field">
                    <div class="select" style="width:100%">
                        <input class="input" id="form-editeur"  style="width:100%" />
                    </div>
                </div>
            </div>
        </div>
...
<div class="container" style="margin-bottom: 100px;">
    ...
    <div style="text-align: center;font-weight: 700"><span id="nbresults"></span> <?php _p('résultats livres'); ?></div>
...
<script>
    ...
    function getResultsList(disp, page) {
        ...
        if($("#form-editeur").val()) {
           additionals = additionals+"/editeur/"+$("#form-editeur").val();
           console.log(additionals);
       	}           
        if($("#form-pays").val()) {
        ...
        if($("#form-album_avec_image").is(":checked")) {
	   	...
	   	if(disp == "tiles") { 
	       	...
	       	let url = "/index.php/Phoi/Livres/Results"+additionals+"/page/"+page;
	       	console.log(url);
		    ...
		    if ( $.fn.dataTable.isDataTable('#search-results-list') ) {
			    ...
			    table.ajax.url("/index.php/Phoi/Livres/ResultsJson"+additionals).load();
			}
			else {
			    table = $('#search-results-list').DataTable({
                    "bStateSave": true,
                    ...
                    'pagingType': 'simple_numbers_no_ellipses',
                    "ajax": {
                        "url" : "/index.php/Phoi/Livres/ResultsJson"+additionals,
		...
		console.log("/index.php/Phoi/Livres/Results"+additionals);
    }
